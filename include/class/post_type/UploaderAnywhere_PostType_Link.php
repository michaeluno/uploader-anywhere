    ...
    public function start() {    
        ...
        $this->setArguments(
            array( // argument - for the array structure, refer to http://codex.wordpress.org/Function_Reference/register_post_type#Arguments
                'labels' => array(
                    'name'               => 'Uploader Link',
                    'all_items'          => __( 'Uploader Links', 'uploader-anywhere' ),
                    'singular_name'      => __( 'Uploader Link', 'uploader-anywhere' ),
                    'add_new'            => __( 'Add Link', 'uploader-anywhere' ),
                    'add_new_item'       => __( 'Add New Uploader Link', 'uploader-anywhere' ),
                    'edit'               => __( 'Edit', 'uploader-anywhere' ),
                    'edit_item'          => __( 'Edit Link', 'uploader-anywhere' ),
                    'new_item'           => __( 'New Uploader Link', 'uploader-anywhere' ),
                    'view'               => __( 'View', 'uploader-anywhere' ),
                    'view_item'          => __( 'View Uploader Link', 'uploader-anywhere' ),
                    'search_items'       => __( 'Search Uploader Link', 'uploader-anywhere' ),
                    'not_found'          => __( 'No Uploader link found', 'uploader-anywhere' ),
                    'not_found_in_trash' => __( 'No Uploader link found in Trash', 'uploader-anywhere' ),
                    'parent'             => __( 'Parent Uploader Link', 'uploader-anywhere' ),
                    'plugin_listing_table_title_cell_link' => __( 'Uploader Links', 'uploader-anywhere' ), // framework specific key. [3.0.6+]
                ),
                'public'            => false,
                'show_ui'           => true,  
