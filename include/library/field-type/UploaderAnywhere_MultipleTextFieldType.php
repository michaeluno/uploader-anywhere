<?php
if ( ! class_exists( 'UploaderAnywhere_MultipleTextFieldType' ) ) :
class UploaderAnywhere_MultipleTextFieldType extends UploaderAnywhere_AdminPageFramework_FieldType {
	...
	protected function getStyles() {
		return ".admin-page-framework-input-label-container.multiple_text { 
            padding-right: 2em;' 
        }";
	}
	...
	protected function getField( $aField ) { 
		...
		private function _getInputs( $aField ) {
			...
			foreach( ( array ) $aField['label'] as $_sSlug => $_sLabel ) {
				...
				$_aOutput[] = 
					"<div class='admin-page-framework-input-label-container multiple_text'>"
