<?php
if ( ! class_exists( 'UploaderAnywhere_RevealerCustomFieldType' ) ) :
class UploaderAnywhere_RevealerCustomFieldType extends UploaderAnywhere_AdminPageFramework_FieldType {
