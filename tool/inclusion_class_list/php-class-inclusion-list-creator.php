...
$sResultFilePath	= $sTargetBaseDir . '/include/uploader-anywhere-include-class-file-list.php';
...
new PHP_Class_Files_Inclusion_Script_Creator(
	$sTargetBaseDir,
	array(  // scan directory paths
        $sTargetBaseDir . '/include/library/field-type', 
	...
	array(  // Options
		...
		'base_dir_var'  	=>	'UploaderAnywhere_Registry::$sDirPath',
		'search'			=>	array(
